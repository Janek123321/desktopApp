...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label->Location = System::Drawing::Point(19, 40);
			this->label->Name = L"label";
			this->label->Size = System::Drawing::Size(0, 37);
			...
			this->button1->GotFocus += gcnew System::EventHandler(this, &MainForm::button1_Enter);
			...
			this->label1->Location = System::Drawing::Point(22, 599);
			...
			this->box->TabIndex = 3;
			this->box->Click += gcnew System::EventHandler(this, &MainForm::box_Click);
			this->box->GotFocus += gcnew System::EventHandler(this, &MainForm::box_Enter);
			...
			// label6
			// 
			this->label6->Location = System::Drawing::Point(377, 189);
